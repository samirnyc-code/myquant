...
OUT = OUT_DIR / "es_regime_0406.html"
SLUG = "20260406"
...
HTML = f"""<title>ES Regime 6 April 2026</title>
...
<div class="wrap">
  ...
  <h1>ES Regime 6 April 2026</h1>
  <p class="standfirst">A session that never left its own opening range &mdash; the high
  (6722.25) printed on bar 7 and the low (6679.00) on bar 2. Six regime changes inside that
  shell, ending with a <b>Bull</b> structure that ran the last 24 bars into the close.</p>
  ...
  <button class="shot" data-full="big" aria-label="Enlarge chart">
    <img id="big" src="data:image/png;base64,{img}" alt="ES regime chart for 6 April 2026">
  ...
  <div class="note">
    <p>The <b>bar 25</b> Bear is the one you flagged. Bar 23 was rejected correctly: the lower
    high at bar 19 (6705.50, under bar 13's 6715.75) was in place, but its reference low is
    <b>bar 16 at 6691.25</b>, and bar 23 only reached 6693.75. Two bars later bar 25 trades
    6688.25 and the break is real.</p>
    <p style="margin-top:10px">Bar 21's low of 6695.25 stays <b>minor</b> &mdash; it never took
    out 6691.25, so it does not become the reference and does not reset the setup. That is the
    same rule that produces the bar 69 entry on 25 June.</p>
  </div>
</div>
